...
<Admonition type="note" title="Installing cert-manager">
  ...
  and the relevant sections of the [AWS](../../../setup/helm-deployments/aws.mdx#step-47-configure-tls-certificates-for-teleport) and [GCP](../../../setup/helm-deploymentss/gcp.mdx#step-47-install-and-configure-cert-manager) guides for more information.
</Admonition>
