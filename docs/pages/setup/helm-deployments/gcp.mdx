...
If you want to use a different version of Teleport, set the [`teleportVersionOverride`](../helm-deployments/teleport-cluster.mdx#teleportversionoverride) value.
